...
const nodes = [
  ...
  { layer: "PoojaVoice", name: "WebRTC / WebSocket", desc: "Streams live audio between Twilio and the voice engine, low-latency." },
  { layer: "PoojaVoice", name: "Deepgram STT", desc: "Converts spoken words to text in real time for intent recognition." },
  { layer: "PoojaVoice", name: "LLM Orchestrator", desc: "Llama-3 / GPT-4o interprets intent and decides the next action." },
  { layer: "PoojaVoice", name: "ElevenLabs TTS", desc: "Turns the agent's response into natural, non-robotic speech." },
...
export default function ArchitectureDetails() {
  return (
    <section
      ...
      className="relative bg-white h-full flex flex-col justify-center px-5 sm:px-6 md:px-12 lg:px-20 py-6"
    >
